...
nng_http_set_version - set HTTP protocol version
...
The `nng_http_set_version()` sets the HTTP protocol version used for _conn_ to _version_.
...
[.text-left]
xref:nng_http_get_version.3http.adoc[nng_http_get_version(3http)],
