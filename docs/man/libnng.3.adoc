...
|xref:nng_http_get_method.3http.adoc[nng_http_get_method()]|return HTTP request method
...
|xref:nng_http_set_method.3http.adoc[nng_http_set_method()]|set HTTP method
|xref:nng_http_req_set_uri.3http.adoc[nng_http_req_set_uri()]|set HTTP request URI
|xref:nng_http_set_version.3http.adoc[nng_http_set_version()]|set HTTP protocol version
